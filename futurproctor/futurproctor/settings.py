...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'npg_ql6rwtgc3Jki',  # Password from the URL
        'HOST': 'ep-autumn-silence-ahiewpe5-pooler.c-3.us-east-1.aws.neon.tech',  # Host from the URL
        'PORT': '5432',  # Default PostgreSQL port
        'OPTIONS': {
            'sslmode': 'require',  # SSL mode from the URL
            'channel_binding': 'require',  # Channel binding from the URL
        },
    }
}
